...
CREATE TABLE `user_cour` (
  ...
  KEY `cour_id` (`cour_id`),
  CONSTRAINT `user_cour_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`userid`),
  CONSTRAINT `user_cour_ibfk_2` FOREIGN KEY (`cour_id`) REFERENCES `course` (`courseid`)
...
INSERT INTO `user_cour` VALUES (0,0),(1,0),(2,0),(0,1),(1,1),(3,1);
...
-- Dump completed on 2019-01-08  1:55:09
